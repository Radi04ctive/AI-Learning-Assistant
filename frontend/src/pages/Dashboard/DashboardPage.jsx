  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative max-w-7xl">
        {/* Headers */}
        <div className="mb-6">
          <h1 className="text-2xl font-medium text-shadow-slate-900 tracking-tight mb-2">Dashboard</h1>
          <p className="text-slate-500 text-sm">Track yourr learning progress and aactivity</p>
        </div>
          ...
          {dashboardData.recentActivity &&
                  ...
                  <div className="group  flex items-center justify-between p-4 rounded-xl bg-slate-50/50 border  border-slate-200/60 hover:bg-white hover:border-slate-300/60 hover:shadow-md transition-all duration-200" key={activity.id || index} >
                    <div className="flex-1 min-w-0 ">
                      <div className="flex items-center gap-2 mb-1">
                        <div className={`size-2 rounded-full ${activity.type === 'document'
                          ? 'bg-linear-to-r from-blue-400 to-cyan-500'
                          : 'bg-linear-to-r from-emerald-400 to-teal-500'
                          }`} />
                        <p className="text-sm font-medium text-slate-900 truncate">
                          {activity.type === 'document' ? 'Accessed Document: ' : 'Atampted Quizzes: '}
            ...
            : (
              <div className="text-center py-12">
                <div className="inline-flex items-center  justify-center  size-16  rounded-2xl bg-slate-100 mb-4">
                  <Clock className="size-8 text-shadow-slate-400" />
                </div>
