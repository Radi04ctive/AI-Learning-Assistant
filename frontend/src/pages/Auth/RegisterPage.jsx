...
import { BrainCircuit, Mail, ArrowRight, User } from "lucide-react";
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none transition-colors duration-200 text-slate-400">
